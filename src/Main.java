...
public class Main extends Application
{
    ...
    public void start(Stage theStage)
    {
        ...
        //Create an keyboard input buffer (allows for diagonal movement)
        ...
        briefcase.setImage("file:Resources/briefcase.png");
        ...
        for (int i = 0; i < 15; i++)
        {
            ...
            moneybag.setImage("file:Resources/moneybag.png");
